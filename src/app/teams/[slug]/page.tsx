import TeamMatchesSlider from '@/components/TeamMatchesSlider';
import { requestParams } from '@/utils/requestParams';
import { teamRoosters } from '@/utils/teamRoosters';
...
async function Teams(props: any) {
  ...
  const team = teamRoosters.filter((team) => team.slug === teamSlug)[0];
    ...
    <main className='relative flex min-h-screen flex-col items-center bg-primary'>
      <section className=' w-full min-h-screen relative flex flex-col justify-start items-center mt-20 '>
        <div className='relative w-full h-96 top-0'>
          <div className='absolute w-full h-full bg-secondary opacity-70 z-[10] top-0 left-0 rounded-lg '></div>
