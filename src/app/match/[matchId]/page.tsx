  ...
  return (
    <main className='relative flex min-h-screen flex-col items-center'>
      <section className='w-full h-[calc(100vh-5.625rem)] mt-[calc(5.625rem)] border-t-[6px] z-[120] relative flex justify-center items-center flex-col lg:flex-row'>
        <div className='w-full relative lg:w-1/2 h-full bg-transparent duration-500 group flex flex-col items-center p-16 lg:p-32 text-accent-gold'>
        ...
        <div className='w-full relative lg:w-1/2 h-full bg-transparent duration-500 group flex flex-col items-center p-16 lg:p-32 text-accent-blue'>
